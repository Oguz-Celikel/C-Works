/*
	Ýzmir Institute of High Technology
	Electical and Electronics Engineering
	
	EE103 Homework (HW1)
	
	Student:
		210206012 - Berkhan Aðar
		berkhan@agar.com.tr
		berkhan.agar.com.tr
*/
...
int main(){
	...
	printf("This program finds roots of the polynomial y=a*x^2 + b*x + c\n");
	...
	if(problem == 1){
		printf("I can't calculate.\nSee you in another life bro! ~ Lost\n");
	}else{
